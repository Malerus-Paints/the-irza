...
-- WEEK 1 — Arc 1-5 open the channel, reclassification backfill closes the week
...
(2,  'Partial Boot',                      'arc',               NULL, 'STANDARD', 1, 'planned', 'Zoo begins responding. Engineering Layer: Not Found. First Malerus seed.',                                                     NOW(), NOW()),
(3,  'First Exhibit',                     'arc',               NULL, 'STANDARD', 1, 'planned', 'Miniatures are the exhibits. Schema mismatch. Classification failure as a finding.',                                           NOW(), NOW()),
(4,  'Behavior Cluster',                  'arc',               NULL, 'STANDARD', 1, 'planned', 'Squads as collective entities. Kinship logic introduced.',                                                                    NOW(), NOW()),
(5,  'Archive Fragment',                  'arc',               NULL, 'STANDARD', 1, 'planned', 'Prior Operator Trace Detected. Malerus teased by System only.',                                                               NOW(), NOW()),
(6,  'Reclassification - archive file 001', 'reclassification', 'A', 'SHORT',   1, 'planned', 'Degradation overlay fades in. Older terminology. Designation only - system can''t verify prior record yet.',                  NOW(), NOW()),
(7,  'Reclassification - archive file 002', 'reclassification', 'A', 'SHORT',   1, 'planned', 'Second archive file surfaces. Terminology conflicts with current system. Designation only.',                                   NOW(), NOW()),

-- WEEK 2
(8,  'Classifying - backlog unit 001',    'classifying',       'A', 'SHORT',    2, 'planned', 'First current-backlog exhibit. System pulled it - reason unknown. Designation only, classification unstable.',                 NOW(), NOW()),
(9,  'Behavior Collective - squad 001',   'behavior_collective','B', 'STANDARD', 2, 'planned', 'First squad exhibit. Collective entity framing. Behavioral note only - no analysis yet. Pattern: Unstable.',                  NOW(), NOW()),
(10, 'Archive Designation',               'arc',               NULL, 'STANDARD', 2, 'planned', 'IRZA formally named. Malerus // Fragmented - first real hint. UI stabilizes slightly.',                                       NOW(), NOW()),
(11, 'Reclassification - archive file 003', 'reclassification', 'A', 'SHORT',   2, 'planned', 'Degradation heavier - file partially illegible. Older terminology conflicts with current schema.',                            NOW(), NOW()),
